...
namespace LibraryProject.Tests.Repositories
{
    public class AuthorRepositoryTests
    {
        ...
        private readonly IConfiguration _configuration; // her

        public AuthorRepositoryTests(IConfiguration configuration)// her
        {
            _configuration = configuration;// her
            ...
            _authorRepository = new(_context, _configuration);// her
        }
        ...
        public async void InsertNewAuthor_ShouldFailToAddNewAuthor_WhenAuthorIdAlreadyExists()
        {
            ...
            // Act
            async Task action() => await _authorRepository.InsertNewAuthorWithProcedure(author);
        ...
        public async void InsertNewAuthor_ShouldAddNewIdToAuthor_WhenSavingToDatabase()
        {
            ...
            // Act
            var result = await _authorRepository.InsertNewAuthorWithProcedure(author);
        ...
        public async void DeleteAuthorById_ShouldReturnDeletedAuthor_WhenAuthorIsDeleted()
        {
            ...
            // Act
            var result = await _authorRepository.DeleteAuthorWithProcedure(authorId);
        ...
        public async void DeleteAuthorById_ShouldReturnNull_WhenAuthorDoesNotExist()
        {
            ...
            // Act
            var result = await _authorRepository.DeleteAuthorWithProcedure(1);
